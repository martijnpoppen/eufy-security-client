...
class Station extends tiny_typed_emitter_1.TypedEmitter {
    ...
    enableDevice(device, value) {
        ...
        if ((device.isIndoorCamera() && !(0, utils_1.isGreaterEqualMinVersion)("2.3.1.2", device.getSoftwareVersion()) && !device.isIndoorCamMini() && !device.isIndoorPanAndTiltCameraS350()) || (device.isWiredDoorbell() && !device.isWiredDoorbellT8200X()) || device.getDeviceType() === types_1.DeviceType.FLOODLIGHT_CAMERA_8422 || device.getDeviceType() === types_1.DeviceType.FLOODLIGHT_CAMERA_8424 || device.isFloodLightT8420X())
        ...
        else if (device.isIndoorPanAndTiltCameraS350() || (device.isIndoorCamera() && (0, utils_1.isGreaterEqualMinVersion)("2.3.1.2", device.getSoftwareVersion()))) {
            this.p2pSession.sendCommandWithStringPayload({
                commandType: types_2.CommandType.CMD_SET_PAYLOAD,
                value: JSON.stringify({
                    "account_id": this.rawStation.member.admin_user_id,
