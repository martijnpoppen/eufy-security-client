...
export const StationPersonNameProperty: PropertyMetadataString = {
    key: "custom_personName",
    name: PropertyName.StationPersonName,
    label: "Person Name",
    readable: true,
    writeable: false,
    type: "string",
...
export const StationProperties: Properties = {
  [DeviceType.STATION]: {
    ...
    [PropertyName.StationPersonName]: StationPersonNameProperty,
